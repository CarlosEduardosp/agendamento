...
class Control:
    """A renderable that inserts a control code (non printable but may move cursor.py).
    ...
    def home(cls) -> "Control":
        """Move cursor.py to 'home' position."""
        return cls(ControlType.HOME)

    @classmethod
    def move(cls, x: int = 0, y: int = 0) -> "Control":
        """Move cursor.py relative to current position.
    ...
    def move_to(cls, x: int, y: int) -> "Control":
        """Move cursor.py to absolute position.
