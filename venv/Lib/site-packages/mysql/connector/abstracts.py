...
class MySQLConnectionAbstract(ABC):
    ...
    def unread_result(self) -> bool:
        ...
        This method is used by cursors to check whether another cursor.py still
...
class MySQLCursorAbstract(ABC):
    """Abstract cursor.py class

    Abstract class defining cursor.py class with method and members
