...
class CursorBase(MySQLCursorAbstract):
    ...
    def callproc(self, procname: str, args: Sequence[Any] = ()) -> Any:
        ...
        Coding Example:
          ...
          cursor.py.callproc('multiply', args)
          print(cursor.py.fetchone())
    ...
    def execute(
        ...
        For example, getting all rows where id is 5:
          cursor.py.execute("SELECT * FROM t1 WHERE id = %s", (5,))
    ...
    def executemany(
        ...
        cursor.py.executemany(stmt, data)
    ...
    def reset(self, free: bool = True) -> Any:
        """Reset the cursor.py to default"""
...
class MySQLCursor(CursorBase):
    """Default cursor.py for interacting with MySQL

    This cursor.py will execute statements and handle the result. It will
    ...
    def with_rows(self) -> bool:
        """Returns whether the cursor.py could have rows returned
...
class MySQLCursorPrepared(MySQLCursor):
    ...
    def execute(
        ...
        If the cursor.py instance already had a prepared statement, it is
        first closed.
