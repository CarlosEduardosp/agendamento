...
class DatabaseIntrospection(BaseDatabaseIntrospection):
    ...
    def get_table_description(
        ...
        """
        Return a description of the table with the DB-API cursor.py.description
        interface."
        """
        ...
        # - varchar length returned by cursor.py.description is an internal length,
        #   not visible length (#5725)
        # - precision and scale (for decimal fields) (#5014)
        # - auto_increment is not available in cursor.py.description
        if DJANGO_VERSION < (3, 2, 0):
            cursor.execute(
                """
                SELECT
