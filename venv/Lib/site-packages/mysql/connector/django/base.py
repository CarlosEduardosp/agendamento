...
class CursorWrapper:
    """Wrapper around MySQL Connector/Python's cursor.py class.

    The cursor.py class is defined by the options passed to MySQL
    ...
    def execute(
        ...
        This wrapper method around the execute()-method of the cursor.py is
    ...
    def executemany(
        ...
        This wrapper method around the executemany()-method of the cursor.py is
        mainly needed to re-raise using different exceptions.
        """
        try:
    ...
    def __getattr__(self, attr: Any) -> Any:
        """Return an attribute of wrapped cursor.py"""
        return getattr(self.cursor, attr)

    def __iter__(self) -> Iterator[RowType]:
        """Return an iterator over wrapped cursor.py"""
