...
class ColumnElement(
    ...
    def _non_anon_label(self) -> Optional[str]:
        ...
        ``cursor.py.description`` as the names.
        ...
        in the ``cursor.py.description``. Examples include SQL functions, CAST
        functions, etc. While such things do return names in
        ``cursor.py.description``, they are only predictable on a
