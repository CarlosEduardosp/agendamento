...
class ResultColumnsEntry(NamedTuple):
    ...
    keyname: str
    """string name that's expected in cursor.py.description"""
    ...
    to the rows that come back from the cursor.py.
...
# integer indexes into ResultColumnsEntry used by cursor.py.py.
...
class SQLCompiler(Compiled):
    ...
    if the number of columns in cursor.py.description does not match how many
    ...
    """if True, and this in insert, use cursor.py.lastrowid to populate
    ...
    @util.preload_module("sqlalchemy.engine.cursor.py")
    ...
    def _inserted_primary_key_from_lastrowid_getter(self):
            ...
            if autoinc_key in self.binds:
                ...
                def _autoinc_getter(lastrowid, parameters):
                    ...
                    if param_value is not None:
                        ...
                        # cursor.py.lastrowid for INSERT..ON CONFLICT so it
        ...
        def get(lastrowid, parameters):
            """given cursor.py.lastrowid value and the parameters used for INSERT,
    ...
    def _label_select_column(
        ...
        if populate_result_map:
            ...
            # with cursor.py.description when the query is executed.
            add_to_result_map = self._add_to_result_map
    ...
    **kw)`` and returns a select object.   this is used for structural changes
    ...
    def _deliver_insertmanyvalues_batches(
        ...
        if imv.is_default_expr and not self.dialect.supports_default_metavalue:
            ...
            # cursor.py.lastrowid etc. still goes through the more heavyweight
