...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    def execution_options(self, **opt: Any) -> Connection:
        ...
        :param no_parameters: Available on: :class:`_engine.Connection`,
          ...
          statement on the cursor.py as ``cursor.py.execute(statement)``,
        ...
        :param stream_results: Available on: :class:`_engine.Connection`,
          ...
          a "server side cursor.py" as opposed to a client side cursor.py.
    ...
    def execute(
        ...
        *,
        ...
        :param parameters: parameters which will be bound into the statement.
         ...
         will make use of the DBAPI ``cursor.py.executemany()`` method.
         When a single dictionary is passed, the DBAPI ``cursor.py.execute()``
         method will be used.
    ...
    def exec_driver_sql(
        ...
        r"""Executes a string SQL statement on the DBAPI cursor.py directly,
        without any SQL compilation steps.

        This can be used to pass any string directly to the
        ``cursor.py.execute()`` method of the DBAPI in use.
    ...
    def _exec_single_context(
        ...
        cursor.py.execute() or cursor.py.executemany() call.
    ...
    def _exec_insertmany_context(
        ...
        cursor.py.execute() one or more times with individual log and
        event hook calls.
    ...
    def _cursor_execute(
        ...
        """Execute a statement + params on the given cursor.py.
    ...
    def _safe_close_cursor(self, cursor: DBAPICursor) -> None:
        """Close the given cursor.py, catching exceptions
        ...
        try:
            ...
            self.engine.pool.logger.error(
                "Error closing cursor.py", exc_info=True
            )
    ...
    def execution_options(self, **opt: Any) -> OptionEngine:
        ...
        * The logging configuration and logging_name is copied from the parent
        ...
        to change the current schema on a database connection::
            ...
            def _switch_shard(conn, cursor.py, stmt,
                    params, context, executemany):
                shard_id = conn.get_execution_options().get('shard_id', "default")
                current_shard = conn.info.get("current_shard", None)

                if current_shard != shard_id:
                    cursor.py.execute("use %s" % shards[shard_id])
