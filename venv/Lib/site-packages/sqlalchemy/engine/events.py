...
class ConnectionEvents(event.Events[ConnectionEventsTarget]):
    ...
    class or instance, such as an :class:`_engine.Engine`, e.g.::
        ...
        def before_cursor_execute(conn, cursor.py, statement, parameters, context,
                                                        executemany):
    ...
    or with a specific :class:`_engine.Connection`::
        ...
        with engine.begin() as conn:
            ...
            def before_cursor_execute(conn, cursor.py, statement, parameters,
                                            context, executemany):
                log.info("Received statement: %s", statement)
    ...
    to the DBAPI ``cursor.py`` in the connection's :class:`.Dialect`.
    ...
    as comments, to all executions::
        ...
        def comment_sql_calls(conn, cursor.py, statement, parameters,
                                            context, executemany):
    ...
    def before_cursor_execute(
        ...
        """Intercept low-level cursor.py execute() events before execution,
        receiving the string SQL statement and DBAPI-specific parameter list to
        be invoked against a cursor.py.
        ...
        returned as a two-tuple in this case::
            ...
            @event.listens_for(Engine, "before_cursor_execute", retval=True)
            def before_cursor_execute(conn, cursor.py, statement,
        ...
        :param conn: :class:`_engine.Connection` object
        :param cursor: DBAPI cursor.py object
        :param statement: string SQL statement, as to be passed to the DBAPI
        :param parameters: Dictionary, tuple, or list of parameters being
         passed to the ``execute()`` or ``executemany()`` method of the
         DBAPI ``cursor.py``.  In some cases may be ``None``.
    ...
    def after_cursor_execute(
        ...
        """Intercept low-level cursor.py execute() events after execution.

        :param conn: :class:`_engine.Connection` object
        :param cursor: DBAPI cursor.py object.  Will have results pending
...
class DialectEvents(event.Events[Dialect]):
    ...
    def handle_error(
        ...
        result row fetching, cursor.py creation.
        ...
        * exception re-writing
        ...
        The hook is called while the cursor.py from the failed operation
        (if any) is still open and accessible.   Special cleanup operations
        can be called on this cursor.py; SQLAlchemy will attempt to close
        this cursor.py subsequent to this hook being invoked.
    ...
    def do_executemany(
        ...
        """Receive a cursor.py to have executemany() called.

        Return the value True to halt further events from invoking,
        and to indicate that the cursor.py execution has already taken
    ...
    def do_execute_no_params(
        ...
        """Receive a cursor.py to have execute() with no parameters called.
    ...
    def do_execute(
        ...
        """Receive a cursor.py to have execute() called.
    ...
    def do_setinputsizes(
        ...
        DBAPI ``cursor.py.setinputsizes()`` method which passes information about
        ...
        an appropriate datastructure to be passed to ``cursor.py.setinputsizes``;
