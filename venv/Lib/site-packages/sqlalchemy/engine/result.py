...
# is overridden in cursor.py using _CursorKeyMapRecType
_KeyMapRecType = Any
...
"""represents the kind of row we get from a DBAPI cursor.py"""
        ...
        if self._unique_filter_state:
            ...
            def manyrows(
                ...
                if num is None:
                    ...
                    # manyrows number, DBAPI has this as cursor.py.arraysize
...
class Result(_WithKeys, ResultInternal[Row[_TP]]):
    ...
    def close(self) -> None:
        ...
        .. versionadded:: 1.4.27 - ``.close()`` was previously not generally
           ...
           in any case, this allows the underlying cursor.py result to be closed
           ...
           exhaust and autoclose the database cursor.py.
    ...
    def yield_per(self, num: int) -> Self:
        ...
        from the underlying cursor.py or other data source will be buffered up to
        ...
        use of a server side cursor.py, if the DBAPI supports a specific "server
        side cursor.py" mode separate from its default mode of operation.
    ...
    def unique(self, strategy: Optional[_UniqueFilterType] = None) -> Self:
        ...
        behavior of the underlying cursor.py or datasource, such that multiple
        underlying calls to ``cursor.py.fetchmany()`` may be necessary in order
    ...
    def merge(self, *others: Result[Any]) -> MergedResult[_TP]:
        ...
        set of result / cursor.py metadata, otherwise the behavior is
        undefined.
