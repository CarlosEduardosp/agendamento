...
class SuiteRequirements(Requirements):
    ...
    def standard_cursor_sql(self):
        """Target database passes SQL-92 style statements to cursor.py.execute()
    ...
    def fetch_rows_post_commit(self):
        """target platform will allow cursor.py.fetchone() to proceed after a
        COMMIT.
    ...
    def emulated_lastrowid(self):
        """target dialect retrieves cursor.py.lastrowid, or fetches
    ...
    def emulated_lastrowid_even_with_sequences(self):
        """target dialect retrieves cursor.py.lastrowid or an equivalent
    ...
    def supports_lastrowid(self):
        """target database / driver supports cursor.py.lastrowid as a means
